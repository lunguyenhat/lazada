...
{    
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_componentbuilder.language';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		if ($id != 0 && (!$user->authorise('language.edit.state', 'com_componentbuilder.language.' . (int) $id))
			|| ($id == 0 && !$user->authorise('language.edit.state', 'com_componentbuilder')))
		{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('language.delete', 'com_componentbuilder.language.' . (int) $record->id);
		}
		return false;
	}
	...
	protected function canEditState($record)
	{
		...
		{
			// The record has been set. Check the record permissions.
			$permission = $user->authorise('language.edit.state', 'com_componentbuilder.language.' . (int) $recordId);
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		return $user->authorise('language.edit', 'com_componentbuilder.language.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or $user->authorise('language.edit',  'com_componentbuilder');
	}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_componentbuilder.edit.language.data', array());
	...
	protected function batchCopy($values, $pks, $contexts)
	{
		...
		elseif (isset($values['published']) && !$this->canDo->get('language.edit.state'))
		{
				$values['published'] = 0;
		}
	...
	protected function batchMove($values, $pks, $contexts)
	{
		...
		if (isset($values['published']) && !$this->canDo->get('language.edit.state'))
		{

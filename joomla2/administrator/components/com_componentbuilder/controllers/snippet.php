 ...
 * Snippet Controller
 */
class ComponentbuilderControllerSnippet extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Snippets'; // safeguard for setting the return view listing to the main view.
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Snippet', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_componentbuilder&view=snippets' . $this->getRedirectToListAppend(), false));

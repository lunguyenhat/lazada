...
class ComponentbuilderControllerDynamic_get extends JControllerForm
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Dynamic_get', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_componentbuilder&view=dynamic_gets' . $this->getRedirectToListAppend(), false));

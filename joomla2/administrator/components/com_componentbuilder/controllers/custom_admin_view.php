...
class ComponentbuilderControllerCustom_admin_view extends JControllerForm
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Custom_admin_view', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_componentbuilder&view=custom_admin_views' . $this->getRedirectToListAppend(), false));

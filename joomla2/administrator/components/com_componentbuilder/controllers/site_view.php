...
/**
 * Site_view Controller
 */
class ComponentbuilderControllerSite_view extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Site_views'; // safeguard for setting the return view listing to the main view.
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Site_view', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_componentbuilder&view=site_views' . $this->getRedirectToListAppend(), false));

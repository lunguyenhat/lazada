...
/**
 * Site_views Controller
 */
class ComponentbuilderControllerSite_views extends JControllerAdmin
{
	 ...
	 * @since	2.5
	 */
	public function getModel($name = 'Site_view', $prefix = 'ComponentbuilderModel', $config = array())
	{
	...
	public function importData()
	{
		...
		if ($user->authorise('site_view.import', 'com_componentbuilder') && $user->authorise('core.import', 'com_componentbuilder'))
		{
			...
			if (ComponentbuilderHelper::checkObject($headers))
			{
				...
				$message = JText::_('COM_COMPONENTBUILDER_IMPORT_SELECT_FILE_FOR_SITE_VIEWS');

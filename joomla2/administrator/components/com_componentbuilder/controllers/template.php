 ...
 * Template Controller
 */
class ComponentbuilderControllerTemplate extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Templates'; // safeguard for setting the return view listing to the main view.
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_componentbuilder&view=templates' . $this->getRedirectToListAppend(), false));

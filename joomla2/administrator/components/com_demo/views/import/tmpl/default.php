...
<?php if ($this->hasPackage && DemoHelper::checkArray($this->headerList)) : ?>
	Joomla.continueImport = function()
	{
		...
		if (error)
		{
			alert("<?php echo JText::_('COM_DEMO_IMPORT_MSG_PLEASE_SELECT_ALL_COLUMNS', true); ?>");
		}
		else
		{
...
<?php else: ?>
	Joomla.submitbutton = function()
	{
		...
		{
			alert("<?php echo JText::_('COM_DEMO_IMPORT_MSG_PLEASE_SELECT_A_FILE', true); ?>");
		}
		else
		{
			jQuery('#loading').css('display', 'block');
	...
	Joomla.submitbutton3 = function()
	{
		...
		if (form.import_directory.value == ""){
			alert("<?php echo JText::_('COM_DEMO_IMPORT_MSG_PLEASE_SELECT_A_DIRECTORY', true); ?>");
		}
		else
		{
			jQuery('#loading').css('display', 'block');
	...
	Joomla.submitbutton4 = function()
	{
		...
		{
			alert("<?php echo JText::_('COM_DEMO_IMPORT_MSG_ENTER_A_URL', true); ?>");
		}
		else
		{
			jQuery('#loading').css('display', 'block');
...
<form enctype="multipart/form-data" action="<?php echo JRoute::_('index.php?option=com_demo&view=import');?>" method="post" name="adminForm" id="adminForm" class="form-horizontal form-validate">
